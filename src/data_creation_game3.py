...
def game_init():
    ...
    screen = pygame.display.set_mode(screenSize.width, screenSize.height, pygame.FULLSCREEN)
...
#             game_save_data(data)
#             screen.fill(255)
#             create_dot(screen, pyautogui.size())
#     else:
#         cv.putText(screen, 'face', (10,30), cv.FONT_HERSHEY_SIMPLEX, 1, (0,0,255),2, cv.LINE_AA)
