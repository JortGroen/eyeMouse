...
class FramesSource(BaseDataSource):
    ...
    def detect_landmarks(self, frame):
        ...
        for face in frame['faces']:
            ...
            #mapping = [0,1,2,3,4]
            landmarks.append(np.array([tuple_from_dlib_shape(i) for i in mapping]))
            mapping_face = [30,8,36,45,48,54]
            face_landmarks.append(np.array([tuple_from_dlib_shape(i) for i in mapping_face], dtype="double"))
